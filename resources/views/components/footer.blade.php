        ...
        <div class="flex justify-start items-start md:mx-20 mx-10 flex-wrap">
            ...
            <div class="max-w-sm">
                ...
                <p class="mt-4 text-white text-justify pr-5">
                    {!! Str::limit(
                        strip_tags(
                            'Kami merupakan usaha bengkel las bergerak dibidang pembuatan dan pemasangan kanopi, railing, tangga, pintu pagar otomatis dll.',
                        ),
                        240,
                        '...',
                    ) !!}
                    ...
                    <div class="flex space-x-4 ">
                        <div>
                            <p class="text-white text-justify pr-2 pb-4">
                                Jl. Kabupaten, RT.07/RW.31, Jaten, Sendangadi, Kec. Mlati, Kab. Sleman, DIY 55285
                            </p>
                            <a href="{{ url('/') }}/info"
            ...
            <div class="max-w-sm md:px-5 px-0">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex space-x-4 border-b border-dashed pb-5">
                        <img src="{{ asset('storage/1.jpeg') }}" alt="Info 1" class="w-18 h-18 rounded-lg" />
                        <div>
                            <a href="#" class="text-white hover:text-yellow-400 font-semibold">Pembuatan Kubah
                                Masjid</a>
                        </div>
                    </div>
                    {{--  --}}
