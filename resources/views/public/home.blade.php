<x-layout>
    ...
    <div class="w-full py-20 px-10 md:px-50 flex justify-start gap-10 text-justify" data-aos="fade-up"
        ...
        <div class="w-full md:w-2/3">
            <span class="px-3 py-2 bg-yellow-500 rounded-xl text-white text-sm md:text-md">Bengkel Las Manser</span>
            <p class="text-yellow-500 text-xl md:text-3xl my-5">08675765756</p>
            <p class="text-blue-900 text-2xl md:text-4xl mb-5 font-bold">Jasa Las Custom dan Fabrikasi Besi atau
                Stainless Steel</p>
            <p class="text-gray-600 text-sm mb-5">Kami melayani pembuatan berbagai jenis konstruksi besi, seperti pagar,
                kanopi, dan
                struktur lainnya yang
                membutuhkan ketahanan dan kekuatan tinggi.</p>
            <a href="#" class="px-5 py-2 bg-blue-900 rounded-2xl text-white text-sm hover:bg-yellow-500">Layanan
                Kami</a>
        </div>
        <div class="hidden md:flex md:flex-col justify-end pl-30 ">
            <a href="#" class="px-5 py-2 bg-yellow-500 hover:bg-blue-900 rounded-2xl text-white text-sm ">Free
                Konsultasi</a>
        </div>
    </div>
    ...
    <div class="flex w-full justify-start flex-col md:flex-row">
        <div class="md:w-1/3 w-full">
            <div id="slider" class="hero overflow-hidden relative w-full aspect-[16/9]">
                ...
                <div class="hero-content text-white text-center absolute inset-0 flex items-center justify-center"
                    style="z-index: 2;">
                    <div class="lg:mx-10 mx-5" id="main-search" data-aos="fade-up" data-aos-duration="1000">
                        <span class="text-xl font-bold text-gray-100">
                            Jasa Bengkel Las Pengerjaan Stainless dan Besi Terbaik di Padang</span>
                        <p class="text-sm font-bold text-gray-100">
                            Bengkel Las Manser</p>
                        <br>
                        <a href="#"
        ...
        <div
            ...
            <span data-aos="fade-right" data-aos-duration="1500">Kami menyediakan berbagai layanan pengerjaan stainless
                steel dan besi berkualitas, termasuk kanopi,
                railing, pintu pagar otomatis, tangga, dan lainnya. </span>
        </div>
    </div>

    {{-- layanan --}}
    <div class="lg:mx-20 md:mx-15 mx-10 mt-10 flex justify-between flex-wrap">
        <div class="shadow-lg w-90  bg-white px-5 pt-5 mb-15" data-aos="fade-down">
            ...
            <span class="text-yellow-500 text-xl font-semibold">01. </span> <span
                class="text-blue-800 text-xl font-semibold">Kanopi</span>
                ...
                <div x-data="{ show: false }" class="w-full border-gray-400 my-5 border py-1 px-3 rounded-md">
                    ...
                    <div class="flex justify-start items-center cursor-pointer" @click="show = !show">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="size-6 text-gray-800" :class="{ 'hidden': show }">
                    ...
                    <!-- Paragraf detail -->
                    <p x-show="show" x-transition class="text-sm text-gray-600 mt-2">
                        Kami siap mengerjakan dan memasang kanopi sesuai dengan kebutuhan dan desain yang Anda inginkan.
                    </p>
                </div>
    ...
    <div class="w-full bg-white flex justify-start flex-wrap " data-aos="fade-up" data-aos-duration="1000">
        <div class="w-full md:w-1/2 aspect-[16/6] md:aspect-[16/4] flex justify-center items-center relative">
            ...
            <div class="">
                <p class="text-yellow-500 text-3xl font-normal">1550+</p>
    ...
    <div class="lg:px-20 md:px-15 px-10 mt-5 flex justify-between flex-wrap">
        <div class="items-center flex justify-center">
            <div class="w-full md:w-2/3" data-aos="fade-right">
                ...
                <p class="text-blue-950 md:text-3xl mb-5 text-md">Bengkel Las Manser</p>
                <a href="#"
                    class="mt-5 px-5 py-2 bg-blue-900 rounded-2xl text-white text-sm hover:bg-yellow-500">Hubungi
                    Kami</a>
            </div>
        </div>
        <div class=""><img src="{{ asset('storage/logo/logo.png') }}" class="md:size-72 size-40"
                data-aos="fade-down"></div>
        <div class="w-full md:w-1/3">
            <p class="text-gray-700 text-justify pt-10" data-aos="fade-right">Kami spesialis dalam pengerjaan
                stainless
                steel dan besi untuk
                berbagai kebutuhan,
                mulai dari pembuatan kanopi, railing, tangga, hingga pintu pagar otomatis dan manual. Berdiri dengan
                tujuan memberikan solusi konstruksi yang kokoh, tahan lama, dan estetik, kami selalu mengutamakan
                kualitas setiap proyek. Dengan pengalaman yang kami miliki, tim ahli kami siap memberikan hasil
                pengerjaan yang sesuai dengan keinginan anda.</p>
        </div>
    </div>
    ...
    <div class="relative w-full">
        ...
        <div class="absolute inset-0 flex items-center justify-center w-full">
            <div class="text-center w-full px-5 md:px-0 md:w-2/4" data-aos="fade-up">
                <p class="text-yellow-500 text-2xl md:text-3xl font-semibold">Jasa Fabrikasi Las Terbaik</p>
                <p class="text-white text-sm md:text-md mb-5">Butuh solusi terbaik untuk kebutuhan kanopi, railing,
                    pagar,
                    atau
                    konstruksi lainnya? Jangan ragu
                    untuk
                    berkonsultasi langsung dengan kami secara gratis!</p>
                <a href="#"
                    class="mt-5 px-5 py-2 bg-blue-900 rounded-2xl text-white text-sm hover:bg-yellow-500">Hubungi
                    Kami</a>
            </div>
